...
export const SPONSORSHIP_AVAILABLE_PATTERN = /\b(?:visa sponsorship (?:is )?available|sponsorship available|will (?:provide|offer) (?:visa )?sponsorship|we sponsor|eligible for sponsorship)\b/i;
